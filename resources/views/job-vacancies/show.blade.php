        ...
        <div class="bg-black shadow-lg rounded-lg p-6 max-w-7xl mx-auto">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div>
                        <a href="{{ route('job-vacancies.apply', $jobVacancy->id) }}" 
                           class="justify-center bg-gradient-to-r from-indigo-500 to-rose-500 text-white rounded-lg px-4 py-2 transition hover:from-indigo-700 hover:to-rose-700">
                            Apply Now
                        </a>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-3 gap-4 mt-6">
                <div class="col-span-2">
                    ...
                    <p class="text-gray-400 mt-2">{{ $jobVacancy->description }}</p>
                </div>
